...
It turns out that only few reactions are multi-subunit reactions, both in the sulfur metabolism. This result means that either the GEM makes wrong assumptions about some of the essential reactions, or that there are un-annotated isoenzymes in _R. eutropha_ that can take over functionality.
