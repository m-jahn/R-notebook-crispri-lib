...
plot_tsne_linreg <- df_tsne %>%
  ...
  labs(title = "t-SNE clustering of genes with absolute fitness > 4 and p-value < 0.01.", 
    subtitle = paste0("dot color/size encodes effect of variable from MLR, n = ", nrow(df_tsne))) +
