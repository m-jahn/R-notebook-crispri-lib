...
$E_x=median(fitness_{x1, y1}, fitness_{x1, y2}, ..., fitness_{x1, yn})$
...
With the correlation (weight) and the efficiency per sgRNA, we can compute the **weighted mean of all sgRNAs**, but also the standard **arithmetic mean** for comparison. Metrics are calculated for log2 FC, and fitness.
