...
Since statistical significane is tested for many genes in parallel, the p-value obtained from MWU test should be multiple-hypothesis corrected. For this purpose we use the Benjamini-Hochberg method (a.k.a. FDR).
...
save_plot(plot_all_fitness_volc, width = 7, height = 5)
```
