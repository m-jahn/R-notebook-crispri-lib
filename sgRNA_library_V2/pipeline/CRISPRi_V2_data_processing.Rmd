...
print_od <- function(data, log = FALSE, ylim = NULL) {
  ...
  ggplot(data, aes(x = time_h, y = mean_OD720,
    ...
    geom_line(size = 1) +
    custom_theme(legend.pos = c(0.15, 0.85), legend.key.size = unit(0.15, "cm"),
      aspect = 1) +
...
ggarrange(ncol = 3, nrow = 2,
  print_od(filter(df_od_summary, comparison == "ΔGAP1")),
  print_od(filter(df_od_summary, comparison == "ΔGAP2")),
  print_od(filter(df_od_summary, comparison == "ΔCP12")),
  print_od(filter(df_od_summary, comparison == "ΔGAP1"), log = TRUE),
  print_od(filter(df_od_summary, comparison == "ΔGAP2"), log = TRUE),
  print_od(filter(df_od_summary, comparison == "ΔCP12"), log = TRUE)
)
```
