...
```{r, fig.width = 5, fig.height = 8}
print(plot_lactate_volcano, position = c(0, 0.72, 1, 1), more = TRUE)
print(plot_2sgRNAs, position = c(0.01, 0.33, 1, 0.74))
grid.text(label = c("A", "B"), x = c(0.03, 0.03), y = c(0.98, 0.74), gp = gpar(cex = 1.2))
```


```{r, results = 'hide', include = FALSE}
svg("../figures/main/Figure5.svg", width = 5, height = 7)
...
#### Supplemental: Genes with 1 or 2 sgRNAs depleted under lactate
