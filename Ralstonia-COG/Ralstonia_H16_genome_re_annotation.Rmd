...
selected, broader COG groups. That's good, because it's a hint that COG categories
contain distinct groups of genes.

```{r}
# A closer look at the genes in Coenzyme group
