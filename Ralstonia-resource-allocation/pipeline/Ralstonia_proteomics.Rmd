...
plot_nmds <- xyplot(MDS2 ~ MDS1, df_nmds,
  ...
  panel = function(x, y, size, ...) {
    ...
    panel.key(..., cex = 0.7, corner = c(0.95, 0.05), points = FALSE)
...
print(gene_plot_1, position = c(0.045, 0.23, 0.425, 0.36), more = TRUE)
print(gene_plot_2, position = c(0.466, 0.23, 0.76, 0.36), more = TRUE)
print(gene_plot_4, position = c(0.75, 0.23, 0.975, 0.36), more = TRUE)
print(plot_cbb, position = c(0, 0, 0.45, 0.29), more = TRUE)
print(plot_fdh, position = c(0.42, 0, 1, 0.29), more = TRUE)
grid::grid.text(c("CBB operon (Chr2)", "S-FDH operon (Chr1)", "M-FDH (Chr1)"), just =c(0,0),
  x = c(0.08, 0.5, 0.78), y = c(0.315,  0.315,  0.315), gp = grid::gpar(cex = 0.7, col = grey(0.3)))
grid::grid.polygon(x = c(0.485, 0.485, 0.74, 0.64), y = c(0.09, 0.26, 0.26, 0.09), 
  gp = grid::gpar(lty = 0, fill = grey(0.5, alpha = 0.1)))
grid::grid.polygon(x = c(0.665, 0.77, 0.96, 0.735), y = c(0.09, 0.26, 0.26, 0.09), 
  gp = grid::gpar(lty = 0, fill = grey(0.5, alpha = 0.1)))
grid::grid.lines(x = c(0.385, 0.405), y = c(0.52, 0.5), gp = grid::gpar(fill = grey(0.5), col = grey(0.5), lwd = 2),
  arrow = grid::arrow(type = "closed", length = unit(0.01, "npc")))
grid::grid.lines(x = c(0.145, 0.165), y = c(0.44, 0.42), gp = grid::gpar(fill = grey(0.5), col = grey(0.5), lwd = 2),
  arrow = grid::arrow(type = "closed", length = unit(0.01, "npc")))
```
